...
def get_dataset(
    ...
    img_size: float = 32,
    val_ratio: float=0.2,
    transform_train: str = "custom_augment_train",
    transform_test: str = "custom_augment_test",
...
def get_dataloader(
    ...
    class_sample_counts = [261, 676, 1169, 1669, 6895, 1458, 3793, 6970, 1560]
    class_weights = 3000/(torch.Tensor(class_sample_counts)+3000)
