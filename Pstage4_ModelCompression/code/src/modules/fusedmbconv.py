...
class FusedMBConv(nn.Module):
    """Fused MBConvBlock used in Efficientnet-V2.
        - Author: Hyerin-oh
    Note:
    ...
    def __init__(
        ...
        # MobileNetv3논문에는 SE를 hidden_dim의 1/4로 고정한다고 나와있는데 여기서는 in_planes 기준으로 하네요 ㅜㅜ
...
class FusedMBConvGenerator(GeneratorAbstract):
    ...
    def __call__(self, repeat: int = 1):
        """call method.
        same MBConv 
        args : expansion ratio , output_planes , stride , kernel size  
        """
        module = []
        t, c, s, k = self.args  
