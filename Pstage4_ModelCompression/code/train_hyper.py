...
def train(
    ...
    # Create optimizer( ['ADAM','ADAMW','SGD']), scheduler, criterion
    if data_config['OPT_NAME'] == 'ADAM':
        optimizer = torch.optim.Adam(
            model_instance.model.parameters(), lr=data_config["INIT_LR"], weight_decay=data_config['WEIGHT_DECAY']
        )
    elif data_config['OPT_NAME'] == 'ADAMW':
        optimizer = torch.optim.AdamW(
            model_instance.model.parameters(), lr=data_config["INIT_LR"], weight_decay=data_config['WEIGHT_DECAY']
        )
    elif data_config['OPT_NAME'] == 'SGD':
    ...
    scheduler = CosineAnnealingWarmupRestarts(
        ...
        min_lr=data_config["INIT_LR"] * data_config['GAP'], 
